...
- [wepy与mpvue](#wepy与mpvue)
- [不支持组件的render函数](./mpvue/components-render-function.MD)
- [不支持在组件上使用 Class 与 Style 绑定原因分析及解决方案](./mpvue/component-class-style.MD)
...
**3.先授权获取用户信息再login会发生什么？**

<img src="https://user-images.githubusercontent.com/35895755/44244965-268d4d00-a209-11e8-8ef4-b80cc7a78af7.png" width="60%" height="60%" />
<img src="https://user-images.githubusercontent.com/35895755/44379952-0af0b200-a53b-11e8-86be-640bf651bc9e.png" width="40%" height="40%" />

- 知道session_key有有效期，有效期并没有被告知开发者，只知道用户越频繁使用小程序，session_key有效期越长
...
- 下图为一般情况下的授权流程，先调用wx.login，再请求获取授权信息。

<img src="https://user-images.githubusercontent.com/35895755/44379940-fa403c00-a53a-11e8-9165-21b217496aad.png" width="60%" height="60%" />
...
**工程化**
原生开发因为不带工程化，诸如NPM包（未来会引入）、ES7、图片压缩、PostCss、pug、ESLint等等不能用。如果自己要搭工程化或者去yeomen上面找。不如直接使用wepy或mpvue。mpvue和wepy都可以和小程序原生开发混写。[参考mpvue-echart](#https://github.com/mpvue/examples/tree/master/echarts)，[参考wepy](https://github.com/Tencent/wepy/issues/1560)。
而问题在于wepy没有引入webpack(wepy@2.0.x任然没有引入)，以上说的这些东西都要造轮子（作者造或自己造）。没有引入webpack是一个重大的硬伤。社区维护的成熟webpack显然更稳定，轮子更多。
...
- [开源框架mpvue解析](https://tech.meituan.com/mt_mpvue_development_framework.html)
